...
@section('title')
Add Face Pack In Prescription | {{ $ins_name }}
@endsection
 ...
 <div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Add Face Pack In Prescription </h4>
...
<form action="{{ route('postFacePackList') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
    @csrf
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Add Face Pack</h4>
            </div><!-- end card header -->
            <div class="card-body">
...
@foreach($facePackLIsts as $allHealthSupplements)
                                <option value="{{ $allHealthSupplements->id }}">{{ $allHealthSupplements->pack_name }}</option>
                                @endforeach
    ...
    <script type="text/javascript">
        ...
        $("#dynamic-arsu").click(function () {
            ...
            $("#dynamicAddRemovesu").append('<tr>' +
                ...
                '@foreach($facePackLIsts  as $allHealthSupplements)<option value="{{ $allHealthSupplements->id }}">{{ $allHealthSupplements->pack_name }}</option>@endforeach</select>' +
                '</td>' +
                '<td>' +
