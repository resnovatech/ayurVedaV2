        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('agreementFormTwo.update',$agrementFormTwoList->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                            @csrf
                            @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <input type="text" name ="name" value="{{ $agrementFormTwoList->name }}" class="form-control nameWiseData" id="searchnew" placeholder="Type Name/Phone/Patient ID" required>
                            </div>
                            <div class="col-6">
                                <label for="" class="form-label">Opd No</label>
                                <input type="text" name="opd_no" value="{{ $agrementFormTwoList->opd_no }}" placeholder="Opd No" class="form-control" id="opd_no" required>
                            </div>
