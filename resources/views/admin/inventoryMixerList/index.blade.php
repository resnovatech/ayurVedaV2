                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a type="button" class="btn btn-primary add-btn" href="{{route('inventoryMixerAdd')}}" ><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                ...
                                <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="customer_name">Main Ingredient</th>

<th class="sort" data-sort="customer_name">Created With</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id">{{ $key+1 }}</td>
                                          <td class="customer_name">{{ $allmedicineEquipment->main_name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a type="button" href="{{ route('inventoryMixerEdit',$allmedicineEquipment->id) }}"
  ...
  <form id="delete-form-{{ $allmedicineEquipment->id }}" action="{{ route('inventoryMixerDelete',$allmedicineEquipment->id) }}" method="POST" style="display: none;">
    @method('DELETE')
                                  @csrf
