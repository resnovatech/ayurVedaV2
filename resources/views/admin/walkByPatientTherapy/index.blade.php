...
@section('title')
@if(Route::is('signatureTherapyList'))
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        @if(Route::is('signatureTherapyList'))
                         <h4 class="card-title mb-0">Signature Package Info</h4>
                        @else
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                           @if(Route::is('signatureTherapyList'))
                                           <button type="button" class="btn btn-primary add-btn" onclick="location.href='{{ route('signatureTherapyAdd') }}'"><i class="ri-add-line align-bottom me-1"></i> Add New Signature Package Appoinment</button>
                                           @else
