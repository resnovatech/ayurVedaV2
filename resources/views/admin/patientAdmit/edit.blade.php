    ...
    {{ $allPatientList->patient_id }}</option>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="datepicker" name="start_date" value="{{ $patientAdmitList->start_date }}" placeholder="Start Date" required>
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        <label for="" class="form-label">End Date</label>
                                        <input type="text" class="form-control" id="datepicker_one" name="end_date" value="{{ $patientAdmitList->end_date }}"  placeholder="End Date" required>
                                    </div>
                                </div>
