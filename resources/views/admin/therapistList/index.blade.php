                                                            ...
                                                            <form action="{{ route('therapist.update',$allTherapistList->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" data-parsley-length="[11, 11]"  value="{{ $allTherapistList->phone_or_mobile_number }}" name="phone_or_mobile_number" id="" required>
                                                                    </div>
                                                                    <div class="col-12 mb-2">
                                                                    ...
                                                                    <div class="col-12 mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" data-parsley-length="[10, 17]" value="{{ $allTherapistList->nid_number }}" name="nid_number" id="" required>
                                                                    </div>
                                                                    <div class="col-12 mb-2">
                                                                    ...
                                                                    <div class="col-12 mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" data-parsley-maxlength="4" value="{{ $allTherapistList->years_of_experience }}" name="years_of_experience" id="" required>
                                                                    </div>
