...
$getPhoneFromPatient = DB::table('patients')
        ...
        $pdf=PDF::loadView('admin.bill.printInvoice',[
            'signaturePackagePriceLIst'=>$signaturePackagePriceLIst,
            'signaturePackageAmount'=>$signaturePackageAmount,
            'paymentPa'=>$paymentPa,
            'paymentP'=>$paymentP,
            'ffB'=>$ffB,
