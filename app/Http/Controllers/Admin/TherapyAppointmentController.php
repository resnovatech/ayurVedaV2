...
class TherapyAppointmentController extends Controller
{
    ...
    public function create(){
       ...
       //dd(1);
               return view('admin.therapyAppointment.create',compact('patientHistory'));
           }
           ...
           public function getTherapyAppointmentDetail(Request $request){
                    ...
                    $data = view('admin.therapyAppointment.getTherapyAppointmentDetail',compact('name','age','email'))->render();
    ...
    public function edit($id)
    {
        ...
        return view('admin.therapyAppointment.edit',compact('therapyAppointmentDateAndTimeList'));
    }
}
